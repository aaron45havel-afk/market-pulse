...
STATE_METROS: dict[str, dict] = {
    ...
    "CA-SF": {
        ...
        "instagram_hashtag": "sanfrancisco",
    ...
    "UT-SLC": {
        ...
        "instagram_hashtag": "saltlakecity",
    ...
    "UT-STG": {
        ...
        "instagram_hashtag": "stgeorgeutah",
    ...
    "FL-JAX": {
        ...
        "instagram_hashtag": "jacksonville",
    ...
    "FL-WPB": {
        ...
        "instagram_hashtag": "westpalmbeach",
    ...
    "FL-FTL": {
        ...
        "instagram_hashtag": "fortlauderdale",
    ...
    "SC-GVL": {
        ...
        "instagram_hashtag": "greenvillesc",
    ...
    "SC-CHS": {
        ...
        "instagram_hashtag": "charlestonsc",
    ...
    "IN-IND": {
        ...
        "instagram_hashtag": "indianapolis",
    ...
    # ── Stub metros — one pin per state we don't yet have a hand-curated
    # ZIP dataset for. Pin shows on /map and the popup carries state-
    # level numbers (home_value, median_rent from CHOROPLETH_STATES);
    # the "Open metro map" CTA is hidden in favor of a "State estimate"
    # marker since /real-estate/{slug}/map has nothing to render. Slug
    # = state code so when a real per-ZIP dataset lands we can swap the
    # stub out and keep the URL stable. Lat/lng = each state's largest
    # metro centroid.
    "AK": {"state": "AK", "metro_label": "Anchorage", "tiktok_hashtag": "anchorage", "instagram_hashtag": "anchorage",
           "subtitle": "Alaska — state-level snapshot pinned at Anchorage. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 61.2181, "lng": -149.9003, "zoom": 11}, "is_stub": True},
    "AL": {"state": "AL", "metro_label": "Birmingham", "tiktok_hashtag": "birmingham", "instagram_hashtag": "birmingham",
           "subtitle": "Alabama — state-level snapshot pinned at Birmingham. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 33.5186, "lng": -86.8104, "zoom": 11}, "is_stub": True},
    "AR": {"state": "AR", "metro_label": "Little Rock", "tiktok_hashtag": "littlerock", "instagram_hashtag": "littlerock",
           "subtitle": "Arkansas — state-level snapshot pinned at Little Rock. Per-ZIP deep-dive not yet available.",
    ...
    "DE": {"state": "DE", "metro_label": "Wilmington", "tiktok_hashtag": "wilmington", "instagram_hashtag": "wilmingtonde",
           "subtitle": "Delaware — state-level snapshot pinned at Wilmington. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 39.7392, "lng": -75.5398, "zoom": 11}, "is_stub": True},
    "HI": {"state": "HI", "metro_label": "Honolulu", "tiktok_hashtag": "honolulu", "instagram_hashtag": "honolulu",
           "subtitle": "Hawaii — state-level snapshot pinned at Honolulu. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 21.3099, "lng": -157.8581, "zoom": 11}, "is_stub": True},
    "IA": {"state": "IA", "metro_label": "Des Moines", "tiktok_hashtag": "desmoines", "instagram_hashtag": "desmoines",
           "subtitle": "Iowa — state-level snapshot pinned at Des Moines. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 41.5868, "lng": -93.6250, "zoom": 11}, "is_stub": True},
    "ID": {"state": "ID", "metro_label": "Boise", "tiktok_hashtag": "boise", "instagram_hashtag": "boise",
           "subtitle": "Idaho — state-level snapshot pinned at Boise. Per-ZIP deep-dive not yet available.",
    ...
    "KY": {"state": "KY", "metro_label": "Louisville", "tiktok_hashtag": "louisville", "instagram_hashtag": "louisville",
           "subtitle": "Kentucky — state-level snapshot pinned at Louisville. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 38.2527, "lng": -85.7585, "zoom": 11}, "is_stub": True},
    "LA": {"state": "LA", "metro_label": "New Orleans", "tiktok_hashtag": "neworleans", "instagram_hashtag": "neworleans",
           "subtitle": "Louisiana — state-level snapshot pinned at New Orleans. Per-ZIP deep-dive not yet available.",
    ...
    "MO": {"state": "MO", "metro_label": "Kansas City (MO)", "tiktok_hashtag": "kansascity", "instagram_hashtag": "kansascity",
           "subtitle": "Missouri — state-level snapshot pinned at Kansas City. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 39.0997, "lng": -94.5786, "zoom": 11}, "is_stub": True},
    "MS": {"state": "MS", "metro_label": "Jackson", "tiktok_hashtag": "jacksonms", "instagram_hashtag": "jacksonms",
           "subtitle": "Mississippi — state-level snapshot pinned at Jackson. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 32.2988, "lng": -90.1848, "zoom": 11}, "is_stub": True},
    "MT": {"state": "MT", "metro_label": "Billings", "tiktok_hashtag": "billings", "instagram_hashtag": "billingsmt",
           "subtitle": "Montana — state-level snapshot pinned at Billings. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 45.7833, "lng": -108.5007, "zoom": 11}, "is_stub": True},
    "NC": {"state": "NC", "metro_label": "Charlotte", "tiktok_hashtag": "charlotte", "instagram_hashtag": "charlottenc",
           "subtitle": "North Carolina — state-level snapshot pinned at Charlotte. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 35.2271, "lng": -80.8431, "zoom": 11}, "is_stub": True},
    "ND": {"state": "ND", "metro_label": "Fargo", "tiktok_hashtag": "fargo", "instagram_hashtag": "fargond",
           "subtitle": "North Dakota — state-level snapshot pinned at Fargo. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 46.8772, "lng": -96.7898, "zoom": 11}, "is_stub": True},
    "NE": {"state": "NE", "metro_label": "Omaha", "tiktok_hashtag": "omaha", "instagram_hashtag": "omaha",
           "subtitle": "Nebraska — state-level snapshot pinned at Omaha. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 41.2565, "lng": -95.9345, "zoom": 11}, "is_stub": True},
    "NH": {"state": "NH", "metro_label": "Manchester", "tiktok_hashtag": "manchesternh", "instagram_hashtag": "manchesternh",
           "subtitle": "New Hampshire — state-level snapshot pinned at Manchester. Per-ZIP deep-dive not yet available.",
    ...
    "OR": {"state": "OR", "metro_label": "Portland (OR)", "tiktok_hashtag": "portland", "instagram_hashtag": "portland",
           "subtitle": "Oregon — state-level snapshot pinned at Portland. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 45.5152, "lng": -122.6784, "zoom": 11}, "is_stub": True},
    "PA": {"state": "PA", "metro_label": "Philadelphia", "tiktok_hashtag": "philly", "instagram_hashtag": "philly",
           "subtitle": "Pennsylvania — state-level snapshot pinned at Philadelphia. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 39.9526, "lng": -75.1652, "zoom": 11}, "is_stub": True},
    "SD": {"state": "SD", "metro_label": "Sioux Falls", "tiktok_hashtag": "siouxfalls", "instagram_hashtag": "siouxfalls",
           "subtitle": "South Dakota — state-level snapshot pinned at Sioux Falls. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 43.5446, "lng": -96.7311, "zoom": 11}, "is_stub": True},
    "VA": {"state": "VA", "metro_label": "Richmond", "tiktok_hashtag": "richmondva", "instagram_hashtag": "richmondva",
           "subtitle": "Virginia — state-level snapshot pinned at Richmond. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 37.5407, "lng": -77.4360, "zoom": 11}, "is_stub": True},
    "VT": {"state": "VT", "metro_label": "Burlington (VT)", "tiktok_hashtag": "burlingtonvt", "instagram_hashtag": "burlingtonvt",
           "subtitle": "Vermont — state-level snapshot pinned at Burlington. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 44.4759, "lng": -73.2121, "zoom": 11}, "is_stub": True},
    "WI": {"state": "WI", "metro_label": "Milwaukee", "tiktok_hashtag": "milwaukee", "instagram_hashtag": "milwaukee",
           "subtitle": "Wisconsin — state-level snapshot pinned at Milwaukee. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 43.0389, "lng": -87.9065, "zoom": 11}, "is_stub": True},
    "WV": {"state": "WV", "metro_label": "Charleston (WV)", "tiktok_hashtag": "charlestonwv", "instagram_hashtag": "charlestonwv",
           "subtitle": "West Virginia — state-level snapshot pinned at Charleston. Per-ZIP deep-dive not yet available.",
           "map_center": {"lat": 38.3498, "lng": -81.6326, "zoom": 11}, "is_stub": True},
